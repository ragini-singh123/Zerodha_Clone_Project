    ...
    <div className='container border-top  mt-5' >
      <div className='row mt-5'>
        <div className='col-3'>
          ...
          <p>
            &copy; 2010 - 2025, Zerodha Broking Ltd.<br />All rights reserved.</p>
          <div className='footer-log'>
          <i class="fa fa-twitter-square" aria-hidden="true"></i><i class="fa fa-facebook-official" aria-hidden="true"></i><i class="fa fa-instagram" aria-hidden="true"></i><i class="fa fa-linkedin" aria-hidden="true"></i>
          </div>
          <hr />
        </div>
        <div className='col' >
